...
$asset_packages_yml = YAML.load_file("#{Rails.root.to_s}/vendor/plugins/asset_packager/test/asset_packages.yml")
$asset_base_path = "#{Rails.root.to_s}/vendor/plugins/asset_packager/test/assets"
